...
logging.info(f"START - {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} - v.9")
...
for user in userlist:
    ...
    try:
        ...
        try:
            ...
            time.sleep(1)
            st_date = browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[33]/div/div[1]/div[1]/mat-form-field/div/div[1]/div[3]/input")
            ...
            time.sleep(1)
            next=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[37]/div/input")
