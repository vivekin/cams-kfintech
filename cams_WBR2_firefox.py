...
logging.info(f"START - {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} - v.11")
...
for user in userlist:
    ...
    try:
        ...
        time.sleep(2)
        customer_serv=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[1]/div/mat-tab-group/mat-tab-header/div[2]/div/div/div[2]/div")
        ...
        try:
            ...
            time.sleep(2)
            delivery_opn=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[3]/div[2]/mat-form-field/div/div[1]/div[3]/mat-select/div/div[2]")
            ...
            time.sleep(1)
            st_date = browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[34]/div/div[1]/div[1]/mat-form-field/div/div[1]/div[3]/input")
            ...
            time.sleep(0.5)
            en_date = browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[34]/div/div[1]/div[2]/mat-form-field/div/div[1]/div[3]/input")
            ...
            time.sleep(1)
            next=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[38]/div/input")
            browser.execute_script("arguments[0].click();", next)
            time.sleep(2)
            pswd=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[3]/div/div/form/div/div/div[12]/div[1]/mat-form-field/div/div[1]/div[3]/input")
            pswd.send_keys(user[1])
            time.sleep(2)
            pswd_confirm=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[3]/div/div/form/div/div/div[12]/div[2]/mat-form-field/div/div[1]/div[3]/input")
            pswd_confirm.send_keys(user[1])
            time.sleep(2)
            submit=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[3]/div/div/form/div/div/div[14]/div[2]/input[1]")
            browser.execute_script("arguments[0].click();", submit)
            time.sleep(15)
            # element wait
