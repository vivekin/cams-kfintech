...
logging.basicConfig(
    filename=f"kfintech_client_firefox_{formatted_datetime}.log",  # Specify the log file name
...
for user in userlist:
    ...
    try:
        ...
        logging.info(f"Current page: {page.text}")
        pan_level = browser.find_element(By.XPATH,"/html/body/form/div[6]/div/table/tbody/tr[1]/td/table/tbody/tr[4]/td[1]/table/tbody/tr[4]/td/table[1]/tbody/tr[5]/td[2]/a",)
        pan_level.click()
        time.sleep(2)
