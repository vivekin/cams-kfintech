...
for user in userlist:
    ...
    try:
        ...
        grow=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[1]/div/mat-tab-group/mat-tab-header/div[2]/div/div/div[5]/div")
        ...
        try:
            # WBR49
            time.sleep(2)
            nav=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[1]/ul/li[6]")
            browser.execute_script("arguments[0].click();", nav)
           
            time.sleep(5)
            output_opn=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[3]/div[1]/mat-form-field/div/div[1]/div[3]/mat-select/div/div[2]/div")
            ...
            st_date = browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[28]/div/div[1]/div[1]/mat-form-field/div/div[1]/div[3]/input")
            ...
            time.sleep(0.5)
            en_date = browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[28]/div/div[1]/div[2]/mat-form-field/div/div[1]/div[3]/input")
