...
logging.basicConfig(
    filename=f"cams_brokerage_firefox_{formatted_datetime}.log",  # Specify the log file name
...
for user in userlist:
    ...
    try:
        ...
        try:
            ...
            checkbox1=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[27]/div/mat-checkbox[1]/label/span[1]")
            browser.execute_script("arguments[0].click();", checkbox1)
            time.sleep(0.5)
            checkbox2=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[27]/div/mat-checkbox[2]/label/span[1]")
            browser.execute_script("arguments[0].click();", checkbox2)
            time.sleep(0.5)
            checkbox3=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[27]/div/mat-checkbox[3]/label/span[1]")
            browser.execute_script("arguments[0].click();", checkbox3)
            time.sleep(0.5)
            checkbox4=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[27]/div/mat-checkbox[4]/label/span[1]")
            browser.execute_script("arguments[0].click();", checkbox4)
            time.sleep(0.5)
            checkbox5=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[27]/div/mat-checkbox[5]/label/span[1]")
            browser.execute_script("arguments[0].click();", checkbox5)
            time.sleep(0.5)
            checkbox6=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[27]/div/mat-checkbox[6]/label/span[1]")
            browser.execute_script("arguments[0].click();", checkbox6)
            time.sleep(0.5)
            checkbox7=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[27]/div/mat-checkbox[7]/label/span[1]")
            browser.execute_script("arguments[0].click();", checkbox7)
            time.sleep(0.5)

            month_sel=browser.find_element(By.XPATH, "/html/body/app-root/div/app-reports/div/div[2]/div/div[2]/div[2]/div[2]/form/div/div/div[28]/div/mat-form-field/div/div[1]/div[3]/mat-select")
