...
logging.basicConfig(
    filename=f"kfintech_old_MFSD262_firefox_{formatted_datetime}.log",  # Specify the log file name
...
for user in userlist:
    ...
    try:
        ...
        pan_level = browser.find_element(By.XPATH,"/html/body/form/div[6]/div/table/tbody/tr[1]/td/table/tbody/tr[4]/td[1]/table/tbody/tr[4]/td/table[1]/tbody/tr[6]/td[2]/a",)
        pan_level.click()
        time.sleep(2)
        page = browser.find_element(By.XPATH,"/html/body/form/div[6]/div/table[1]/tbody/tr/td/table[1]/tbody/tr[1]/td/table/tbody/tr/td",)
        browser.execute_script("""
                                 var chatbot = document.querySelector('div[data-id="zsalesiq"]');
                                 if (chatbot) chatbot.remove();
                             """)
        ...
        all_fund = browser.find_element(By.XPATH,"/html/body/form/div[6]/div/table[1]/tbody/tr/td/table[1]/tbody/tr[4]/td/table/tbody/tr/td[2]/div/table/tbody/tr[1]/td/input",)
        all_fund.click()
        time.sleep(1)
        email = browser.find_element(By.XPATH,"/html/body/form/div[6]/div/table[1]/tbody/tr/td/table[1]/tbody/tr[6]/td/div/input[1]",)
        email.click()
        try:
            time.sleep(0.5)
            email2 = browser.find_element(By.XPATH,"/html/body/form/div[6]/div/table[1]/tbody/tr/td/table[1]/tbody/tr[6]/td/div/input[2]",)
            email2.click()
            time.sleep(0.5)
            email3 = browser.find_element(By.XPATH,"/html/body/form/div[6]/div/table[1]/tbody/tr/td/table[1]/tbody/tr[6]/td/div/input[3]",)
            email3.click()
            time.sleep(0.5)
            email4 = browser.find_element(By.XPATH,"/html/body/form/div[6]/div/table[1]/tbody/tr/td/table[1]/tbody/tr[6]/td/div/input[4]",)
            email4.click()
            time.sleep(0.5)
            email5 = browser.find_element(By.XPATH,"/html/body/form/div[6]/div/table[1]/tbody/tr/td/table[1]/tbody/tr[6]/td/div/input[5]",)
            email5.click()
        except Exception as e:
            pass
        time.sleep(1)
        extraction_pass = browser.find_element(By.XPATH,"/html/body/form/div[6]/div/table[1]/tbody/tr/td/table[1]/tbody/tr[7]/td/table/tbody/tr[5]/td[2]/input",)
        extraction_pass.send_keys(user[2])
        time.sleep(1)
        extraction_pass_confirm = browser.find_element(By.XPATH,"/html/body/form/div[6]/div/table[1]/tbody/tr/td/table[1]/tbody/tr[7]/td/table/tbody/tr[6]/td[2]/input",)
        extraction_pass_confirm.send_keys(user[2])
        time.sleep(1)
        submit = browser.find_element(By.XPATH,"/html/body/form/div[6]/div/table[1]/tbody/tr/td/table[1]/tbody/tr[8]/td/input",)
        submit.click()
        logging.info("Mailback request submitted")
        time.sleep(4)
        try:
            page = browser.find_element(By.XPATH,"/html/body/form/div[6]/div/table[1]/tbody/tr/td/table[2]/tbody/tr[1]/td/table/tbody/tr/td/span",)
            browser.execute_script("""
                                 var chatbot = document.querySelector('div[data-id="zsalesiq"]');
                                 if (chatbot) chatbot.remove();
                             """)
